...
public class Admin_forgot extends JFrame {
...
//	private final Action action = new SwingAction();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Admin_forgot frame = new Admin_forgot();
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				else
				{
					try 
					{
						...
						String query = "SELECT Mobile_no FROM admin_registration WHERE Mobile_no = '"+textField.getText()+"'";
...
//		OTP_Button.setAction(action);
		...
		Verify_Button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				{
					Admin_verify v1 = new Admin_verify();
					v1.setVisible(true);
					dispose();
				}
			}
		...
		JLabel lblNewLabel_3 = new JLabel("Set OTP");
